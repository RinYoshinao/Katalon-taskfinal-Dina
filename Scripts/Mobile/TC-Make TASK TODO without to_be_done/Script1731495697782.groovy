...
Mobile.setText(findTestObject('Object Repository/Mobile/Create TASK TODO/android.widget.EditText - Enter task title'), 'TAK8_Katalon Mobile', 
    0)
...
WebUI.verifyElementText(findTestObject('Mobile/Verify_TextNegative/android.widget.Toast - Please add task'), '', FailureHandling.OPTIONAL)
