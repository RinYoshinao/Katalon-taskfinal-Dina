...
WebUI.verifyElementVisible(findTestObject('Website/Registrasi/Page_OWASP Juice Shop/alert_Please provide a password'))

WebUI.verifyElementVisible(findTestObject('Website/Registrasi/Page_OWASP Juice Shop/alert_Please repeat your password'))
